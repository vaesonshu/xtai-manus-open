...
export function TaskTimeline({
  ...
  return (
    <div ref={rootRef} className={className}>
      <ScrollArea className="h-full px-4 md:px-6 [&_[data-slot=scroll-area-scrollbar]]:hidden [&_[data-slot=scroll-area-viewport]]:[scrollbar-width:none] [&_[data-slot=scroll-area-viewport]]:[-ms-overflow-style:none] [&_[data-slot=scroll-area-viewport]]:[&::-webkit-scrollbar]:hidden">
        <div
          ref={contentRef}
          className="mx-auto max-w-3xl space-y-2 py-6"
        >
